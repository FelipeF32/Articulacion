 ...
 * precionmin, preciomax, rango de precios nombnre reciente
...
const getProductos = async (req, res) => {
    try {
        const {categoriaId,
            ...
            // filtros base soolo para productos activos y con stock
        const where = {
            activo: true,
            stock: { [Op.gt]: 0}
        };
        ...
        if (buscar) {
            where[Op.or] = [
                ...
                { descripcion: { [Op.like]: `%${buscar}%` } }, //premite buscar por nombre o descripcion
            ];
        }
