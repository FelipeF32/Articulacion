...
const catalogoController = require ('../controllers/cataglogo.controller');
...
// get /api/admin/categorias/categorias
router.get('/catalogo/categorias:id/stats', catalogoController.getCategorias);

// get /api/cataglogo/categorias/:id/subcategorias
router.post('/catalogo/categorias:id/subcategorias', catalogoController.getSubcategoriasPorCategorias);

// get /api/catalogo/destacados
router.put('/catalogo/destacados', catalogoController.getProductosDestacados);
...
// GET /api/cliente/pedidos/;id
router.put('/cliente/pedidos/:id', verificarAuth, pedidoController.getPedidoById);

// PUT /api/cliente/pedidos/:id/cancelar
router.patch('/cliente/pedidos/:id/cancelar', verificarAuth, pedidoController.cancelarPedido);
